...
1. **/comedouro-automatico-para-pet/** → **/comedouro-vdrbg-4l-wifi-review/** — score 53/100
...
- **Origem:** `/comedouro-automatico-para-pet/`
  ...
  **Anchor sugerido:** "Obesidade em Gatos: Um Problema Mais Comum do que Parece"
  **Motivo:** relação pilar↔satélite identificada — conteúdo complementar dentro do mesmo cluster editorial; similaridade moderada de conteúdo/título/headings
  **Evidências:** título compartilha termo(s): comedouro, automatico; headings compartilham termo(s): comedouro, gatos, automatico; conteúdo compartilha termo(s): comedouro, racao, gatos; slug compartilha termo(s): comedouro, automatico; relação pilar↔satélite identificada — conteúdo complementar dentro do mesmo cluster editorial
...
- **Origem:** `/comedouro-automatico-para-pet/`
  **Destino:** `/cat-mate-c500-review/`
  **Score:** 45/100
  **Anchor sugerido:** "Como Funciona o Sistema de Refrigeração"
  **Motivo:** relação pilar↔satélite identificada — conteúdo complementar dentro do mesmo cluster editorial; similaridade moderada de conteúdo/título/headings
...
- **Origem:** `/comedouro-automatico-vale-a-pena/`
  ...
  **Motivo:** similaridade moderada de conteúdo/título/headings
  **Evidências:** título compartilha termo(s): comedouro, vale, pena; headings compartilham termo(s): comedouro, funciona, pros; conteúdo compartilha termo(s): comedouro, nao, 4l; slug compartilha termo(s): comedouro
